...
interface IMorphoBase {
    ...
    /// - The oracle should not be able to go up by more than 1/(LLTV*LIF) instantly. In particular, if the loan asset
    /// is a vault, the oracle should not price its shares using the AUM.
