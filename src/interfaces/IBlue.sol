...
interface IBlue is IFlashLender {
    ...
    function supply(Market memory market, uint256 amount, address onBehalf, bytes memory data)
        external
    ...
    function borrow(Market memory market, uint256 amount, address onBehalf, address receiver)
        external
        returns (uint256 shares);
    function repay(Market memory market, uint256 shares, address onBehalf, bytes memory data)
        external
        returns (uint256 amount);
