...
contract Morpho is IMorpho {
    ...
    function supply(
        ...
        IERC20(marketParams.loanableToken).safeTransferFrom(msg.sender, address(this), assets);
    ...
    function withdraw(
        ...
        IERC20(marketParams.loanableToken).safeTransfer(receiver, assets);
    ...
    function liquidate(
        ...
        IERC20(marketParams.loanableToken).safeTransferFrom(msg.sender, address(this), repaidAssets);
